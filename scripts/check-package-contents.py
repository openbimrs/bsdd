...
EXPECTED = {'openbim-bsdd': ['.cargo_vcs_info.json', 'Cargo.lock', 'Cargo.toml', 'Cargo.toml.orig', 'LICENSE', 'LICENSES/MIT.txt', 'README.md', 'src/lib.rs'], 'bsdd': ['.cargo_vcs_info.json', 'Cargo.lock', 'Cargo.toml', 'Cargo.toml.orig', 'LICENSE', 'LICENSES/MIT.txt', 'README.md', 'src/lib.rs']}
